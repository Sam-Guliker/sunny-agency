...
export function Testimonials() {
    ...
    return (
        <section data-scroll-section className="testimonials-container container">
            <h2 data-scroll className="heading-02 heading-02--testimonials">Client testimonials</h2>
            <div data-scroll className="testimonial-wrapper">
